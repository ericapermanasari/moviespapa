...
const dropdownItemClass = "block w-full text-left px-4 py-3 text-sm text-gray-200 hover:bg-gradient-to-r hover:from-red-600 hover:to-blue-700 hover:text-white transition-all duration-300 rounded-md";
const subDropdownItemClass = "block w-full text-left px-4 py-2.5 text-sm text-gray-200 hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-700 hover:text-white transition-all duration-300 rounded";
        ...
        <div className="flex items-center space-x-6">
          ...
          <Link href="/" className="flex items-center text-3xl font-bold transition-all duration-500 group relative">
            ...
            <span className="rainbow-text hover-glow transition-all duration-500 relative">
              Moviespapa
              <span className="absolute -inset-1 bg-gradient-to-r from-red-600 to-pink-600 rounded-lg blur opacity-30 group-hover:opacity-70 transition duration-1000 group-hover:duration-200"></span>
            </span>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            <button
              ...
              className="flex items-center text-white font-semibold hover:text-blue-400 transition-all duration-300 px-4 py-2 rounded-lg hover:bg-gradient-to-r hover:from-blue-900/30 hover:to-blue-900/30 group relative overflow-hidden"
            >
              <span className="relative z-10 flex items-center">
                <FaStar className="mr-2 text-blue-400 group-hover:scale-110 transition-transform" />
                Erotic
              </span>
              <span className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-blue-600/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></span>
            </button>
            
            {/* Tombol Adult dengan efek khusus */}
            <button
              onClick={() => handleAdultContentClick('adult-list')}
              className="flex items-center text-white font-semibold hover:text-red-300 transition-all duration-300 px-4 py-2 rounded-lg hover:bg-gradient-to-r hover:from-blue-900/30 hover:to-blue-900/30 group relative overflow-hidden"
            >
              <span className="relative z-10 flex items-center">
                <FaExclamationTriangle className="mr-2 text-red-400 group-hover:scale-110 transition-transform" />
                Adult
              </span>
              <span className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-blue-700/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></span>
            </button>
          </div>
        </div>
        ...
        <div className="lg:hidden bg-slate-900/95 dark:bg-gray-900/95 backdrop-blur-lg border-t border-slate-700/50 mt-3 p-6 rounded-b-2xl shadow-2xl">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <button
              ...
              className="flex items-center text-white font-semibold hover:text-blue-300 transition-all duration-300 py-3 px-4 rounded-xl hover:bg-gradient-to-r hover:from-blue-900/30 hover:to-blue-900/30 text-left"
            >
              ...
              <div className="grid grid-cols-2 gap-3 pl-2">
                {tvCategories.map((category) => (
                  <Link 
                    ...
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    {category.icon && <category.icon className="mr-2 text-blue-400 text-xs" />}
                    {category.label}
                  </Link>
                ))}
              </div>
