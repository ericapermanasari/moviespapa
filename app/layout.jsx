...
export const metadata = {
  title: 'Watch Movies Online Free | Stream TV Series HD - MoviesPapa',
  description: 'Find where to watch movies & TV series online for free or on Netflix, Disney+, Prime Video. MoviesPapa tracks 10,000+ movies, 5,000+ shows, box office results, actor info, and provides HD streaming guides across all genres (action, horror, romance, anime, drakor).',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'MoviesPapa - Watch Movies Online Free and Stream TV Series',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="canonical" href="https://moviespapa.netlify.app" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "MoviesPapa",
              "url": "https://moviespapa.netlify.app",
              "logo": "https://live.staticflickr.com/65535/54827245624_9a6913a1bd_b.jpg",
              "description": "Streaming guide and movie database",
              "sameAs": [
                "https://twitter.com/WatchStream123",
                "https://facebook.com/MoviesPapa"
              ]
            })
          }}
        />
          ...
          <div className="flex flex-col min-h-screen bg-slate-900">
            ...
            <div className="w-full bg-slate-900 py-2">
              <div className="max-w-7xl mx-auto px-4 flex justify-center">
                <AdBanner 
                  adId="728x90_header"
                  scriptKey="37dda57d94ca04b373a1cf3b4317123c"
                  height={90} 
                  width={728}
            ...
            <footer className="w-full max-w-7xl mx-auto px-4 py-8">
              <div id="container-9156c3de27e1ec2f44f51e093659fb12"></div>
              <Footer />
            </footer>
          </div>
